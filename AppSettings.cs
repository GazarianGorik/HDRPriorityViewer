...
namespace WwiseHDRTool
{
    public static class AppSettings
    {
        ...
        public static readonly SolidColorPaint chartPointHighlightedStroke = new SolidColorPaint(Utility.LightenColor(SKColors.LightGoldenrodYellow, 0, 0.1f)) { StrokeThickness = 4 };
